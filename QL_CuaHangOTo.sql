...
/* =====================================================
   📌 BẢNG DÒNG XE (Model) – giống Carmudi
   ===================================================== */
CREATE TABLE DongXe (
...
/* =====================================================
   📌 BẢNG XE – giống Carmudi (chi tiết, thông số)
   ===================================================== */
CREATE TABLE Xe (
...
/* =====================================================
   📌 BẢNG NGƯỜI MUA LIÊN HỆ NGƯỜI BÁN
   ===================================================== */
CREATE TABLE LienHe (
...
/* =====================================================
   📌 BẢNG LƯU XE YÊU THÍCH – giống Carmudi
   ===================================================== */
...
📞 **Liên hệ ngay để xem xe – lái thử trực tiếp**  
Xe đang trưng bày tại showroom Carpla Phạm Văn Đồng, hỗ trợ xem xe tại nhà theo yêu cầu.'
WHERE IdXe IN('XE001','XE002','XE003''XE004', 'XE005', 'XE006', 'XE007','XE008', 'XE009', 'XE010', 'XE011','XE012', 'XE013', 'XE014', 'XE015', 'XE016');
...
/* =====================================================
   THÊM DỮ LIỆU BẢNG LÁI THỬ (5 dòng)
   ===================================================== */
...
/* =====================================================
   THÊM DỮ LIỆU BẢNG ĐẶT CỌC (5 dòng)
   ===================================================== */
